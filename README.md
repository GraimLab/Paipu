...
```
If you would like to query multiple cancer types for a mammal you may enter the organism only once, and have additional cancers listed in the second column on subsequent rows (full example in `input/input_ex2.csv`):
